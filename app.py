...
# ---------------------------------------------------------------------------
# IMPORTACIÓN CONDICIONAL DE PYTHONCOM (solo para Windows)
# ---------------------------------------------------------------------------
import sys
if sys.platform == "win32":
    import pythoncom  # Se importa solo en Windows para manejar COM
else:
    pythoncom = None
...
def generar_reporte_word(area_df, responsables_df_dict, mes_str):
    ...
    area_heading.style.font.size = Pt(16)
    area_heading.style.font.color.rgb = RGBColor(0, 0, 0)
    ...
    respons_heading.style.font.size = Pt(16)
    respons_heading.style.font.color.rgb = RGBColor(0, 0, 0)
    ...
    for resp, datos in responsables_df_dict.items():
        ...
        resp_heading.style.font.size = Pt(12)
        resp_heading.style.font.color.rgb = RGBColor(0, 0, 255)
